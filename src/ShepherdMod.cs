...
namespace ShepherdMod.ShepherdMod {

    public class ShepherdMod : ModSystem
    {
        ...
        {
            api.Logger.Debug("[ShepherdMod] StartServer");
            base.Start(api);
        }

        public override void Start(ICoreAPI api)
        {
            api.Logger.Debug("[ShepherdMod] Start");
            base.Start(api);

            api.RegisterItemClass("ShepherdStaff", typeof(ShepherdStaff));
        }
    }

    public class ShepherdStaff : Item
    {
